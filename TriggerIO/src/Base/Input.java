...
public class Input {
    ...
    public enum Setting{ALL, CHANNEL, NOTE};
    ...
    //---------------------------------------------------------------------
    public Element get(Document doc, Setting inAttribute) {
    ...
    //---------------------------------------------------------------------
    public void addChannel(Element element) {
        element.setAttribute(PCHANNEL, String.valueOf(channel));
    }

    //---------------------------------------------------------------------
    public void addNote(Element element) {
        element.setAttribute(PNOTE, String.valueOf(note));
    }
    ...
    public final void setChannel(int value) {
        this.channel = value;
        Common.logger.log(Level.FINEST, "inputNumber<{0}>, channel<{1}>", new Object[] {this.number, this.channel});
    }
    ...
    public final void setNote(int value) {
        if (lovNote.containsKey(value)) {
            this.note = value;
            Common.logger.log(Level.FINEST, "inputNumber<{0}>, note<{1}>", new Object[] {this.number, this.note});
        } else {
